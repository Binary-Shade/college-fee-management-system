...
<nav id="sidebar" class='mx-lt-5 bg-primary' >
		...
		<div class="sidebar-list text-white">
				<a href="index.php?page=home" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-tachometer-alt "></i></span>  Admin Panel</a>
				...
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-cog"></i></span> Admin settings</a>
